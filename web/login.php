 ...
 *
 * $Id: login.php,v 1.55 2005-07-22 22:26:02 matthew Exp $
 * 
 */
...
try again'));
        ...
        setcookie('pb_test_cookie', '1', null, '/',OPTION_WEB_PREFIX.OPTION_WEB_DOMAIN, false);
...
function set_login_cookie($P, $duration = null) {
    ...
    setcookie('pb_person_id', person_cookie_token($P->id(), $duration), is_null($duration) ? null : time() + $duration, '/', OPTION_WEB_PREFIX.OPTION_WEB_DOMAIN, false);
}
