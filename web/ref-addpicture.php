 ...
 *
 * $Id: ref-addpicture.php,v 1.1 2005-06-06 18:28:53 francis Exp $
 * 
 */
...
<?
    if ($picture_upload_allowed) { 
?>
    <form id="pledgeaction" enctype="multipart/form-data" action="/<?=$q_h_ref?>/addpicture" method="POST">
        <h2>Add picture to your pledge</h2>
        <input type="hidden" name="MAX_FILE_SIZE" value="<?=$picture_size_limit*1024?>" />
        <p>Choose the picture you would like to add to your pledge.
