...
page_header(_('Success Stories'), array('id'=>'success'));
...
function story_front() {
    ...
    echo '</ul>';
    echo p(_('Here at PledgeBank, we&rsquo;re quite proud of the actions people
have taken to improve their communities. Each of the successful pledges on the
site mark something significant &ndash; trees planted, books distributed,
friendships formed, votes cast, money donated, letters written, and a whole
host of other actions.  We&rsquo;re happy to say that people all over the world
have created change and taken initiative in a wide variety of ways, and would
like to share some of our favourite success stories with you.'));
...
function story_airfarespledge() {
    echo h2(_('airfarespledge success story'));
    echo p(_('Fiona, one of the creators of the <a
href="/airfarespledge">airfarespledge</a>, writes to say:'));
    echo p('<img align="right" src="/i/airfarespledge.jpeg" style="margin: 0 0 0.5em 0.5em; border: solid 1px #666666;" title="'
        . _('My best friend in Biloxi MS') . '" alt="' . _('The creator of the pledge with a friendly dog, tagged 595') . '">'
	. _('&ldquo;After seeing the news about Hurricane Katrina, which had some pretty graphic
...
for me.'));
    echo p(_('&ldquo;My pledge was originally to raise some money to help pay for airfares to get
...
way through.'));
    echo p(_('&ldquo;Unfortunately two months later, the plans with CERMT fell through as they were not efficient
...
get some accomodation for the night though.'));
    echo p(_('&ldquo;There is so much more to this story, but, if you are wanting to find out what we did,
you can <a href="/airfarespledge">contact me</a> through my pledge and
I will respond from you there.'));
    echo p(_('&ldquo;I still keep in contact with people and have a friendship and would once again, like to thank everyone who helped.&rdquo;'));
}
