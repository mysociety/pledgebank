...
//
// $Id: explain.php,v 1.4 2005-06-23 23:32:32 matthew Exp $
...
print _("<h2>Tell the world \"I'll do it, but only if you'll help me do it\"</h2>");

print _('<p>You can <a href="tom-on-pledgebank-vbr.mp3">listen to an MP3</a> of this instead.');
?>
...
print _("<p>Hello.  I'm Tom Steinberg, the director of mySociety, the charitable
...
using the written word.</p>");
print _("<p>We all know what it is like to feel powerless, that our own actions
...
pounds to a cause that actually needed a thousand.</p>");
print _("<p>The way it works is simple.  You create a pledge which has the basic
...
but only if three people who live in my street will help me to run it'</p>");
print _("<p>The applications of PledgeBank are limitless.  If you are a parent
...
come along'.</p>");
print _("<p>PledgeBank has been undergoing real world testing for a few weeks
...
along.</p>");
print _("<p>PledgeBank isn't just limited to people who use the internet a lot.
...
and so on.</p>");
print _("<p>PledgeBank is free, easy to use, and needs your involvement
...
and create a pledge right now.  Thank you.</p>");
print '</blockquote> <p><a href="/">' . _('To PledgeBank front page') . '</a>';
page_footer();
