...
//
// $Id: ref-index.php,v 1.11 2005-06-02 08:13:44 francis Exp $
...
function draw_spreadword($p) {
    ...
    <li> <a href="<?=$p->url_creator()?>" title="Only if you made this pledge">Add a picture to your pledge</a> (creator only)
    </li>
    </ul>
    <br clear="all">
    <?
