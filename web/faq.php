...
<!-- This doesn't apply to Live Simply - see microsites_new_pledges_prominence
<dt>Why does my new promise not appear on the All Promises page? </dt>
<dd>New promises have their own page, and are not shown elsewhere on the site until a few people have signed up to them. This is to make sure we only show good quality promises, which have an active creator and some support behind them. So get out there and tell your friends and neighbours about your promise to live simply!</dd> -->
