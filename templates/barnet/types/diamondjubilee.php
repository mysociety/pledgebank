...
<h2>Diamond Jubilee: Street Party in your street</h2> 
<div class='ms-diamondjubilee-banner' style="height:200px;"></div>
...
<ul>
    <li>
       email you the Diamond Jubilee street party application form that you will need to close off your street
    </li>
    <li>
