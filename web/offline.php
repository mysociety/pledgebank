...
//
// $Id: offline.php,v 1.17 2007-07-31 16:36:56 matthew Exp $
...
message details, and take your message out into the big wide world."));
    ...
    print '<div>' . p(_("So if you want to create a pledge, or if you have seen one on this
site that you really endorse, fire up the printer and take your message out into the big wide world.")) . '</div>';
}

print p('<a href="/">' . _('To PledgeBank front page') . '</a>');
