...
print dd(_('PledgeBank has been built under the by mySociety thanks to the effort
...
print dd(_("Nope. When you sign up to a pledge we will tell you a specific maximum
