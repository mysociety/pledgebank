...
//
// $Id: success.php,v 1.1 2007-10-12 13:12:47 matthew Exp $

$hugs = '<h3><a href="/give3hugsaday">Make people smile &ndash; give3hugsaday</a></h3>
...
$first1000 = '
<p><img class="r" alt="First1000 logo"
...
array('summary' => '
<p><img src="/i/airfarespledge.tn.jpeg" class="r" title="My best friend in Biloxi MS" alt="The creator of the pledge with a friendly dog, tagged 595">
...
money, and being an international person, donating money, just didn&rsquo;t work
for me.</p>
<p><a href="/success/airfarespledge">Continue reading&hellip;</a></p>
',
'entry' => '
<p><img class="r" src="/i/airfarespledge.tn.jpeg" title="My best friend in Biloxi MS" alt="The creator of the pledge with a friendly dog, tagged 595">
<h3><a href="/success/airfarespledge">Organise aid trip to New Orleans &ndash; airfarespledge</a></h3>
<p>&ldquo;After seeing the news about Hurricane Katrina, which had some pretty graphic
pictures showing the damage, I thought of how I could help....Being a fan
of Jazz music and knowing a lot about New Orleans, Harry Connick Jr was the
...
<p><img class="r" alt="Election observer Becky, outside a polling station"
...
<a href="http://www.openrightsgroup.org/e-voting-main/" title="ORG&rsquo;s report into
the May 2007 elections">our 65-page report</a> which was recently
launched with significant press coverage.&rdquo;
',
'entry' => '
<p><img class="l"
alt="Election observer Becky, outside a polling station"
src="http://www.openrightsgroup.org/wp-content/uploads/observers.jpg" width="195" height="200"></p>
<h3><a href="/electionwatch07">Gather people to monitor elections &ndash; electionwatch07</a></h3>
<p>&ldquo;Basically,
without PledgeBank I doubt we would have had nearly as many election observers
...
<p>&ldquo;&hellip;having a website where you can get that colourful
data of people&rsquo;s thoughts, experience and opinions can provide us with some
insight in how people are changing their lives.

<p><img class="r" alt="LiveSimply logo"
...
to change their lifestyle, which is a qualitative objective (i.e it&rsquo;s hard to
...
<p>&ldquo;Also, we wanted to use the system that was tested and which we wouldn&rsquo;t have
to customize too much. mySociety was my choice because I like the ethical
background of the organisation.&rdquo;
',
), array(
'summary' => '
<p><img class="r" alt="Save The Sycamore" width="150" height="200"
...
',
'entry' => '
<p><img class="l" alt="Save The Sycamore" width="150" height="200"
src="http://www.pledgebank.com/pics/SaveTheSycamore.jpeg"></p>
<h3><a href="/SaveTheSycamore">Campaign to save a local tree &ndash; SaveTheSycamore</a></h3>
...
<p>&ldquo;Harnessing the power
of collective action is made much easier by this easy-to-use tool.

[&hellip;]

&ldquo;As a result of the pledges, a vegetarian orphanage has an irrigation system,
and areas of land have been converted to food production, so that the
institution can be self-sufficient. We&rsquo;ve also raised money for scientific
...
<p>&ldquo;I&rsquo;ve followed MySociety&rsquo;s projects for some time, and when PledgeBank was
...
signed up to tell their friends and get them to sign up too. As we&rsquo;ve done more
pledges, we&rsquo;ll email people who have signed up to related pledges telling them
...
<p>&ldquo;I heard about PledgeBank through reading Michael Norton&rsquo;s book 365
...
could get other individuals to change their habits this would start adding up!&rdquo;
<p><a href="/success#showerpower">Continue reading&hellip;</a></p>
',
'entry' => '
<h3><a href="/showerpower">Help the environment &ndash; showerpower</a></h3>
...
<p>&ldquo;A few people I don&rsquo;t know somewhere in the world signed the
