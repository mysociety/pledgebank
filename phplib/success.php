...
'entry' => '
<p><img class="r" src="/i/airfarespledge.tn.jpeg" title="' . _('My best friend in Biloxi MS') . '"
alt="' . _('The creator of the pledge with a friendly dog, tagged 595') . '">
<h3><a href="/success/airfarespledge">' . _('Organise aid trip to New Orleans') . ' &ndash; airfarespledge</a></h3>' .
p(_('&ldquo;After seeing the news about Hurricane Katrina, which had some
pretty graphic pictures showing the damage, I thought of how I could
...
<p><img class="r" alt="' . _('Election observer Becky, outside a polling station') .'"
...
<p><img class="l" alt="' . _('Election observer Becky, outside a polling station') . '"
src="http://www.openrightsgroup.org/wp-content/uploads/observers.jpg" width="195" height="200"></p>
<h3><a href="/electionwatch07">' . _('Gather people to monitor elections') . ' &ndash; electionwatch07</a></h3>' .
p(_('&ldquo;Basically, without PledgeBank I doubt we would have had nearly
as many election observers volunteer. The public nature of PledgeBank also
...
community.&rdquo;')),
'entry' => '
<p><img class="l" alt="' . _('Save The Sycamore') . '" width="150" height="200"
src="http://www.pledgebank.com/pics/SaveTheSycamore.jpeg"></p>
<h3><a href="/SaveTheSycamore">' . _('Campaign to save a local tree') . ' &ndash; SaveTheSycamore</a></h3>' .
p(_('&ldquo;The amount of elderly people who supported me in this pledge by
writing and phoning the council was phenomenal. Thank you so much for
