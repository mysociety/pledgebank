...
<div id="barnet_expl">
  ...
  <div style="border:1px solid white;">
    <div style="border-top: 4px solid #00ada1;margin-top:1em;">
      <h3><a href="/new/adoptastreet" title="Adopt a Street" >Adopt a Street</a></h3>
      <p>        
        We're supporting residents up to ten streets in Barnet to
        adopt their street with the following pledges:
        sign up or <a href="/new/adoptastreet">start a pledge</a> to adopt your street!
      </p>
      <!--
      <ul style="margin-left:2em;">
          <li><a href="/example-rd-bl">Eaxmple&nbsp;Road,&nbsp;NW11</a></li>          
      </ul>
      -->
    </div>
  </div>
