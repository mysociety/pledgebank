 ...
 *
 * $Id: pledge.php,v 1.202 2006-08-24 12:17:12 francis Exp $
 * 
 */
...
<? if ($this->byarea()) { ?>
<p class="byareamadeby"><?=sprintf(_("Pledge orginally made by %s"), $this->h_name_and_identity()) ?></p>
<? } ?>
...
function post_confirm_advertise($pledge, $curr_page) {
    $random = rand(1,2);
    if ($random==1) {
        $random = 'friends';
