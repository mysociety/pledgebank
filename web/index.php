...
//
// $Id: index.php,v 1.88 2005-03-17 09:20:39 francis Exp $
...
function pdfs() {
    ...
    $pdf_flyers_url = new_url("../flyers/{$ref}_A4_flyers.pdf", false);
    ?>
...
<li><a href="<?=$pdf_flyers_url?>">Flyers for getting out and giving to people (A4)</a></li>
</ul>
<?  return true;
}
